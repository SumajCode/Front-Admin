...
export async function loadWebComponents() {
  ...
  try {
    ...
    await Promise.all([
      import('@/components/auth/AuthGuard').then(() =>
        console.log('✅ WebComponents: AuthGuard imported'),
      ),
      import('@/components/auth/LogoutButton').then(() =>
        console.log('✅ WebComponents: LogoutButton imported'),
      ),
      import('@/components/auth/UserInfo').then(() =>
        console.log('✅ WebComponents: UserInfo imported'),
      ),
    ])
